...
function isCorrectOption($option, $correctAnswer, $questionType, $options = null, $index = null) {
    ...
    if ($questionType === 'single_choice') {
        ...
        // For drag_drop, we use the index directly
        return isset($correctAnswer[$index]);
    }
                                            ...
                                            <?php foreach ($question['options'] as $index => $option): ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <?php if (isCorrectOption($option, $question['correct_answer'], $question['question_type'])): ?>
                                        ...
                                        <?php if (isset($question['options']) && is_array($question['options'])): ?>
                                            <?php foreach ($question['options'] as $index => $dragItem): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php 
                                                        if (isset($question['correct_answer']) && is_array($question['correct_answer']) && isset($question['correct_answer'][$index])) {
                                                            echo htmlspecialchars($question['correct_answer'][$index]);
                                                        }
                                                        ?>
                                                    </td>
                                                </tr>
