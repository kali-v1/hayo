...
<div class="container-fluid">
    <div class="neo-card mb-4">
        ...
        <?php
            ...
            $form_data = $_SESSION['form_data'] ?? $employee;
            unset($_SESSION['form_data']);
            ?>
            
            <form action="/admin/employees/update/<?php echo $employee['id']; ?>" method="post">
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <div class="input-group">
                                <input type="password" class="form-control neo-input" id="password" name="password">
